...
public class EMediumPropertiesUI extends JDialog {
	...
	private JComboBox eMediumTypeList;
...
//TODO: handle update = false!!		
		
		eMediumTypeList = new JComboBox(eMediumTypes);
		...
		if (loadData) {			
			...
			mimeTypeTextField.setText((String) dialogData.getAttribute(EMediumAttribute.INTERNET_TYPE));
			...
			ActionListener al = new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					if (e.getActionCommand().equals("Create")) {
						...
						EMediumPropertiesUI.this.dialogData.addAttribute(EMediumAttribute.INTERNET_TYPE, mimeTypeTextField.getText());
