...
abstract class BookshelfUI extends IBookshelfUI {
	...
	private void internalAddToEMediaPanel(EMedium eMedium, JPopupMenu contextMenu) {
		try {
			...
			// super, mega, hiper vudu!!!! The name "EMedium" must match the "getEMedium" and
			// "setEMedium" from EMediumLabel. If you put "eMedium" instead of "EMedium" 
			// the drag and drop does not work and you loose 3 days looking for the reason!!!!!!
			...
			e.printStackTrace(); // remove line after debuging!
